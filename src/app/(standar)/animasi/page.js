...
import ATN from "./material/atn"
import Aruntala from "./material/aruntala"
import BankBCA from "./material/bankbca"
      ...
      <>
        <div className="w-full flex flex-col justify-center mb-4">
          ...
          <Link
            ...
            className="w-auto h-16 text-purple-500"
          >
        ...
        <div className="w-full grid grid-cols-2 sm:grid-cols-4 gap-4 p-3">
          <button
            onClick={(e) => openDialog(e.target.value)}
            className="bg-tertiary hover:opacity-70 p-3 rounded"
            value="Blackadders"
          >
            Blackadders
          </button>
          ...
          <button
            onClick={(e) => openDialog(e.target.value)}
            className="bg-tertiary hover:opacity-70 p-3 rounded"
            value="Bank BCA(Belum Selesai)"
          >
            Bank BCA
          </button>
          {/* <button onClick={(e) => openDialog(e.target.value)} className="bg-tertiary hover:opacity-70 p-3 rounded" value='ATN'>ATN</button> */}
        </div>
        <Modal show={dialog} onClose={closeDialog}>
          <div className="text-white text-xl m-3 p-2 bg-secondary rounded flex">
            ...
            <div className="">
              <button
                className="bg-tertiary hover:opacity-70 px-2 rounded"
                onClick={closeDialog}
              >
                X
              </button>
          ...
          <div className="flex justify-center m-5">
            ...
            {NamaAnimasi === "Aruntala" && <Aruntala />}
            {NamaAnimasi === "Bank BCA(Belum Selesai)" && <BankBCA />}
            {/* {NamaAnimasi === 'ATN' && (<ATN />)} */}
          </div>
        </Modal>
      </>
